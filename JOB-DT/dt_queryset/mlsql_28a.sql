...
FROM keyword k
CROSS JOIN movie_keyword mk
CROSS JOIN complete_cast cc
CROSS JOIN comp_cast_type cct1
CROSS JOIN company_counts
CROSS JOIN keyword_counts
CROSS JOIN comp_cast_type cct2
CROSS JOIN cast_counts
CROSS JOIN mi_budget
CROSS JOIN mi_votes
CROSS JOIN title t
CROSS JOIN kind_type kt
CROSS JOIN movie_info mi
CROSS JOIN info_type it1
CROSS JOIN movie_info_idx mi_idx
CROSS JOIN info_type it2
CROSS JOIN movie_companies mc
CROSS JOIN company_type ct
CROSS JOIN company_name cn
